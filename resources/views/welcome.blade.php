...
<body class="bg-white text-gray-700 font-sans overflow-x-hidden">
            ...
            <div class="homax-project-track px-4 sm:px-6 lg:px-8">
                ...
                <a href="{{ route('property.show', $property->id) }}"
                    ...
                    <div class="relative h-[270px] sm:h-[285px] xl:h-[300px] overflow-hidden rounded-b-[26px] bg-[#F2F4FF]">
                        ...
                        @else
                        <div class="w-full h-full bg-[#F2F4FF] flex items-center justify-center">
    ...
    <section class="py-10 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-[#000030] rounded-[26px] px-6 py-8 md:px-10 lg:px-12 lg:py-12 overflow-hidden">
                <div class="grid grid-cols-1 lg:grid-cols-[0.95fr_1.65fr] gap-8 lg:gap-12 items-center">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="h-32 md:h-40 lg:h-44 rounded-2xl overflow-hidden bg-[#00004D]">
                            @if ($property->main_image)
                            <img loading="lazy" decoding="async" src="{{ asset($property->main_image) }}" alt="{{ $property->title }}"
    ...
    <section class="relative overflow-hidden bg-[#F2F4FF] lg:min-h-[560px]">
        ...
        <div class="absolute bottom-[-170px] right-[18%] h-[360px] w-[520px] rounded-[50%] bg-[#E6E9FF]/55"></div>
        ...
        <div class="relative lg:absolute lg:inset-y-0 lg:left-0 lg:w-[50%] min-h-[300px] md:min-h-[430px] lg:min-h-full overflow-hidden rounded-br-[90px] lg:rounded-r-[42%]">
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-[#F2F4FF]/20"></div>
        </div>
    ...
    <section class="py-20 bg-gradient-to-br from-white via-[#F2F4FF] to-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="property-scroll-wrapper flex gap-6" style="min-width: max-content;">
                            ...
                            <a href="{{ route('property.show', $property->id) }}"
                                ...
                                <img loading="lazy" decoding="async" src="{{ asset($property->main_image) }}" alt="{{ $property->title }}"
                                    class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                                @else
                                <div class="absolute inset-0 bg-[#E6E9FF] flex items-center justify-center">
                                    <span class="text-[#687386] text-sm">No Image Available</span>
                                </div>
                                @endif

                                <div class="absolute inset-0 bg-gradient-to-t from-[#000030]/96 via-[#000030]/35 to-transparent"></div>
